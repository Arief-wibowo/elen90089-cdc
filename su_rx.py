...
class su_rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "su_rx")
        ...
        self.zeromq_sub_source_0 = zeromq.sub_source(gr.sizeof_gr_complex, 1, 'tcp://127.0.0.1:55000', 100, False, (-1), '', False)
        ...
        self.root_raised_cosine_filter_0 = filter.fir_filter_ccf(
            ...
            firdes.root_raised_cosine(
                ...
                0.35,
                (11*sps)))
        self._rf_freq_range = Range(70e6, 6e9, 1e3, 928e6, 200)
        ...
        self.connect((self.zeromq_sub_source_0, 0), (self.analog_feedforward_agc_cc_0, 0))
...
def main(top_block_cls=su_rx, options=None):
